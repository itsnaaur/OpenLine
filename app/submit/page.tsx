...
import { Upload, CheckCircle2, Copy, Loader2, Lock, Shield, ArrowRight } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-[#e6f4f8] to-[#d9eaf5] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-4 md:p-6 relative">
          ...
          <div className="hidden md:block absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-20 right-20 w-72 h-72 bg-[#0dc7e4]/20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-20 left-20 w-72 h-72 bg-[#116aae]/20 rounded-full blur-3xl"></div>
          </div>
          ...
          <div className="w-full max-w-lg mx-auto bg-white md:bg-white/80 md:backdrop-blur-md rounded-lg md:rounded-2xl lg:rounded-3xl shadow-lg md:shadow-2xl p-5 md:p-6 lg:p-8 xl:p-10 text-center relative z-10 border-0 md:border border-gray-200/50 animate-fade-in px-2 md:px-0">
            <div className="mb-8">
              <div className="mx-auto w-20 h-20 bg-gradient-to-br from-[#0d87bc] to-[#0dc7e4] rounded-2xl flex items-center justify-center mb-6 shadow-lg animate-fade-in">
                <CheckCircle2 className="w-12 h-12 text-white" />
              </div>
              <h1 className="text-4xl font-extrabold text-gray-900 mb-3 bg-gradient-to-r from-[#116aae] to-[#0da2cb] bg-clip-text text-transparent">
                Report Submitted!
              </h1>
            ...
            <div className="bg-gradient-to-br from-[#e6f4f8] to-[#d9eaf5] border-2 border-[#0da2cb]/50 rounded-2xl p-8 mb-8 shadow-inner">
              <p className="text-sm font-medium text-gray-600 mb-3 uppercase tracking-wide">Your Access Code</p>
              <p className="text-5xl font-mono font-bold bg-gradient-to-r from-[#116aae] to-[#0da2cb] bg-clip-text text-transparent mb-6 tracking-wider">
                {accessCode}
              </p>
              <button
                onClick={copyToClipboard}
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#116aae] to-[#0da2cb] text-white rounded-xl hover:from-[#224092] hover:to-[#0d87bc] transition-all font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
              >
            ...
            <div className="space-y-3">
              <a
                ...
                className="block w-full px-6 py-4 bg-gradient-to-r from-[#116aae] to-[#0da2cb] text-white rounded-xl hover:from-[#224092] hover:to-[#0d87bc] transition-all font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
              >
                Track Your Report
              </a>
              <button
            ...
            <div className="mt-8 p-4 bg-[#e6f4f8]/50 rounded-xl border border-[#0da2cb]/30">
          ...
          <div className="w-full max-w-2xl mx-auto relative z-10 px-2 md:px-0">
            <div className="bg-white md:bg-white/80 md:backdrop-blur-md rounded-lg md:rounded-xl lg:rounded-2xl shadow-lg md:shadow-2xl p-4 md:p-5 lg:p-6 xl:p-7 border-0 md:border border-gray-200/50">
              <div className="mb-6 md:mb-7">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 md:px-3 md:py-1.5 bg-[#0dc7e4]/20 backdrop-blur-sm rounded-full text-[#116aae] text-xs font-medium mb-3 md:mb-4 border border-[#0da2cb]/30">
                  <Shield className="w-3 h-3" />
                  <span>100% Anonymous</span>
                </div>
                <h1 className="text-xl md:text-2xl lg:text-3xl font-extrabold text-gray-900 mb-2 md:mb-3 bg-gradient-to-r from-[#116aae] to-[#0da2cb] bg-clip-text text-transparent">
            ...
            <div>
              ...
              <select
                ...
                required
                className="w-full px-3 py-2 md:px-4 md:py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-[#116aae] focus:border-[#116aae] outline-none transition-all bg-white hover:border-gray-300 text-sm"
              >
                  ...
                  <label
                    ...
                    className={`flex items-center justify-center p-2.5 md:p-3 border-2 rounded-lg cursor-pointer transition-all font-medium text-xs md:text-sm ${
                      formData.urgency === level
                        ...
                        : "border-gray-200 hover:border-[#0da2cb] hover:bg-gray-50"
                    }`}
                  >
                    <input
                      type="radio"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 md:px-4 md:py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-[#116aae] focus:border-[#116aae] outline-none resize-none transition-all bg-white hover:border-gray-300 text-sm"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex justify-center px-4 pt-4 pb-4 md:px-5 md:pt-5 md:pb-5 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0da2cb] hover:bg-[#e6f4f8]/30 transition-all cursor-pointer group">
                <div className="space-y-1 text-center">
                  <Upload className="mx-auto h-8 w-8 md:h-10 md:w-10 text-gray-400" />
                  <div className="flex text-xs md:text-sm text-gray-600">
                    <label
                      htmlFor="evidence"
                      className="relative cursor-pointer bg-white rounded-md font-medium text-[#116aae] hover:text-[#0da2cb] focus-within:outline-none"
                    >
                  ...
                  {file && (
                    <p className="text-sm text-[#116aae] font-medium mt-2">
                      Selected: {file.name}
                    </p>
                  )}
                </div>
